...
<body>
	...
	<div class="center-content-login">
		<br/><br/><br/>
	  	<p class="text-center h33">매거진노트 로그인</p>
	  		<div class="row wow"> 
			<div class="col-md-8 col-md-offset-2 col-sm-12 single-post">
			<br/><br/>
				<form name="loginForm" id="loginForm" action="${pageContext.servletContext.contextPath}/user/login_blog" method="POST">
		...
		<div class="content">
			...
			<div class="col-md-4"></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.servletContext.contextPath}/user/join" class="join">매거진노트 가입하기</a>
		</div>
	</div>
	</div>
